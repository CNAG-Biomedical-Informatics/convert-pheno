...
<div className="button-row">
  <Link className="button button--primary" to="/conversion-recipes">Find routes / recipes</Link>
  <Link className="button button--secondary" to="/tutorial">Read the tutorial</Link>
...
Use [Conversion Routes](conversion-recipes) for route-specific examples. Use this page when you want to understand the CLI model and option groups.
:::
