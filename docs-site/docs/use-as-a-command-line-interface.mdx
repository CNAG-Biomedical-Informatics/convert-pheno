...
<div className="button-row">
  ...
  <Link className="button button--secondary" to="/tutorial">Guided examples</Link>
...
:::tip[Need a command for a specific route?]
Use [Choose a Conversion](conversion-recipes) for route-specific examples. Use this page when you want to understand the CLI model and option groups.
:::
...
- [Common CLI Patterns](usage) for more examples
