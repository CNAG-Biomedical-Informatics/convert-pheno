...
<div className="button-row">
  <Link className="button button--primary" to="/conversion-recipes">Copy-paste recipes</Link>
...
Use [Conversion Recipes](conversion-recipes) for short examples. Use this page when you want to understand the CLI model and option groups.
:::
