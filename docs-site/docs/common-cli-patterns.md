...
Commands are now maintained in one place so that route examples do not drift
between the CLI reference, tutorial, and format guides.
...
The page URL remains available for bookmarks and external references. New
documentation should link directly to the relevant page above.
