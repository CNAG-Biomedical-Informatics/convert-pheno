...
- **OMOP-CDM to Beacon v2 mapping work:** accepted in *BMC Medical Informatics and Decision Making* and expected online soon. The supporting repository is available at [OMOP-CDM to Beacon v2](https://github.com/CNAG-Biomedical-Informatics/omop-cdm-2-beacon-v2). This work documents the OMOP-to-Beacon mapping effort implemented in `Convert-Pheno`.
