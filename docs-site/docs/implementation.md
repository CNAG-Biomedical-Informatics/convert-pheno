...
Most users find the [CLI](use-as-a-command-line-interface) suitable for their needs. Begin by experimenting with the data in the [Web App UI Playground](https://convert-pheno.cnag.cat).
