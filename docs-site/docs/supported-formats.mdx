...
<div className="convertFormatGrid">
  <a className="convertFormatCard" href="bff">
  ...
  <a className="convertFormatCard" href="pxf">
  ...
  <a className="convertFormatCard" href="cdisc-odm">
    <span className="convertCardLabel">Mapping file</span>
    <h3>CDISC-ODM</h3>
    <p>XML input using the same mapping model as other tabular conversions.</p>
  </a>
  <a className="convertFormatCard" href="csv">
    <span className="convertCardLabel">Mapping file</span>
    <h3>CSV</h3>
...
<figcaption>Supported conversions. Dotted blue lines go via BFF, which serves as the internal center model for most routes.</figcaption>
