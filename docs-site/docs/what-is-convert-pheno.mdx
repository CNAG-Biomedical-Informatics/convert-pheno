...
- [Legacy Web App UI](https://cnag-biomedical-informatics.github.io/convert-pheno-ui/) for interactive exploration; it will be deprecated soon, so prefer the CLI, module, or API for supported workflows
