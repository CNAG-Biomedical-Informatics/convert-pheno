...
Conversion of the documented CDISC ODM-XML v1 structure is implemented and covered by regression tests. Independent validation across diverse vendor exports remains limited. ODM v2 and other CDISC exchange formats are not currently supported.
