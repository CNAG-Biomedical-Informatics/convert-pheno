...
REDCap conversion is implemented and covered by regression tests, including data-dictionary and mapping-file processing. Because REDCap projects are free-form, review the project mapping, optional ontology search audit, and generated output. Independent validation across diverse REDCap projects remains an ongoing process.
...
3. Mapping file (YAML or JSON) (see [Guided Examples](tutorial))
